        ...
        .then((data) => {
            ...
            let stringElements = data.data
                .map((d) => {
                    return (
                        `<tr>
                            <td class="border border-slate-500 text-center">${d.id}</td>
                            <td class="border border-slate-500 px-2">${d.name}</td>
                            <td class="border border-slate-500 px-2">${d.age}</td>
                        </tr>`
                        )
                    })
                    .join("")
